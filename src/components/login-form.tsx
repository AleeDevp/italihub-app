...
export function LoginForm({ className, ...props }: React.ComponentProps<'div'>) {
  ...
  const onSubmit = (values: LoginFormValues) => {
    console.log('LoginForm - Form submitted:', values);
    form.clearErrors();
  ...
  useEffect(() => {
    ...
    if (state.message) {
      if (state.success && state.user) {
        ...
        console.log('LoginForm - Login successful, updating auth context:', state.user);
        login(state.user);
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="user@example.com" disabled={isPending} {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
