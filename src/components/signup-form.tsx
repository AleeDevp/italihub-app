...
export function SignupForm({ className, ...props }: React.ComponentProps<'div'>) {
  ...
  useEffect(() => {
    console.log('SignupForm - State updated:', state);
    if (state.message) {
      if (state.success && state.user) {
        toast.success(state.message);

        console.log('SignupForm - Signup successful, updating auth context:', state.user);
        login(state.user);
        ...
        setTimeout(() => {
          console.log('SignupForm - Redirecting to home page');
          router.push('/');
        }, 1500);
      } else {
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Mario" type="text" {...field} disabled={isPending} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Rossi" type="text" {...field} disabled={isPending} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
